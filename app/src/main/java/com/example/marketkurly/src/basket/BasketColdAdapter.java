...
public class BasketColdAdapter extends BaseAdapter {


    FirebaseStorage storage = FirebaseStorage.getInstance("gs://marketcurly-e978c.appspot.com");

    LayoutInflater mLayoutInflater = null;
    private ArrayList<BasketInfoResponse.ColdProduct> arrayList;
    ...
    @Override
    public BasketInfoResponse.ColdProduct getItem(int position) {
    ...
    public BasketColdAdapter(ArrayList<BasketInfoResponse.ColdProduct> arrayList, Context mContext, BasketOnItemClick listener) {
    ...
    public void increment() {
        mCallback.onClickCold(price, price_before);
    ...
    public void isCheckedPrice() {
        if (checked) {
            mCallback.onClickCold(price_current, price_current_before);
        } else {
            mCallback.onClickCold(-price_current, -price_current_before);
        }
    }
    ...
    public void basketChangeBodyDeliver(){
        mCallback.onColdDelivery(arrayList);
    }
