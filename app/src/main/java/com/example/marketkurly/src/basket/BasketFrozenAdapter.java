...
public class BasketFrozenAdapter extends BaseAdapter {


    FirebaseStorage storage = FirebaseStorage.getInstance("gs://marketcurly-e978c.appspot.com");

    LayoutInflater mLayoutInflater = null;
    private ArrayList<BasketInfoResponse.FrozenProduct> arrayList;
    ...
    @Override
    public BasketInfoResponse.FrozenProduct getItem(int position) {
    ...
    public BasketFrozenAdapter(ArrayList<BasketInfoResponse.FrozenProduct> arrayList, Context mContext, BasketOnItemClick listener) {
    ...
    public void increment() {
       mCallback.onClickFrozen(price, price_before);
    ...
    public void isCheckedPrice() {
        if (checked) {
            mCallback.onClickFrozen(price_current, price_current_before);
        } else {
            mCallback.onClickFrozen(-price_current, -price_current_before);
        }
    }
    ...
    public void basketChangeBodyDeliver(){
        mCallback.onFrozenDelivery(arrayList);
    }
