...
public class RelatedAdapter extends RecyclerView.Adapter<RelatedAdapter.CustomViewHolders> {
    ...
    public RelatedAdapter(ArrayList<ProductData> arrayList) {
        this.arrayList = arrayList;
    }

    @NonNull
    @Override
    public RelatedAdapter.CustomViewHolders onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
